...
impl Default for TurkiumdConfig {
    fn default() -> Self {
        Self {
            mute: false,
            path: None,
...
impl TryFrom<TurkiumdConfig> for Vec<String> {
    type Error = Error;
    fn try_from(args: TurkiumdConfig) -> Result<Vec<String>> {
...
impl Turkiumd {
    pub fn new(args: TurkiumdConfig) -> Self {
        Self {
    ...
    pub fn configure(&self, config: TurkiumdConfig) -> Result<()> {
...
#[async_trait]
pub trait TurkiumdCtl {
    async fn version(&self) -> Result<String>;
    async fn configure(&self, config: TurkiumdConfig) -> Result<()>;

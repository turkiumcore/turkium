use crate::{
    error::{Error, Result},
    resolver::{Resolver, TurkiumdResponseReceiver, TurkiumdResponseSender},
};
...
impl Pending {
    fn new(sender: TurkiumdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: TurkiumdPayloadOps, request: &TurkiumdRequest) -> TurkiumdResponseReceiver {

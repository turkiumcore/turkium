use super::{
    ...
    interface::{DynTurkiumdMethod, Interface},
};
use crate::{
...
impl RequestHandler {
    ...
    pub async fn handle_request(&self, request: TurkiumdRequest) -> GrpcServerResult<TurkiumdResponse> {
        let id = request.id;

...
/// Represents the ID of a Turkium transaction
...
/// Represent Turkium transaction input verbose data
...
/// Represent Turkium transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent Turkium transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]

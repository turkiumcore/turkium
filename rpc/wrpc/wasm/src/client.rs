//!
//! # WASM bindings for the [Turkium p2p Node RPC client](TurkiumRpcClient).
//!
//! This module provides a WASM interface for the Turkium p2p Node RPC client
//! - [`RpcClient`].
//!
...
///
/// There are two ways to connect: Directly to any Turkium Node or to a
...
/// ```
///
/// **Connecting to a Turkium Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            TurkiumRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<TurkiumRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<TurkiumRpcClient> {
        &self.inner.client
    }
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = TurkiumRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Turkium BlockDAG.
    ...
    /// Turkium BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Turkium BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Turkium BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Turkium BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Turkium BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Turkium BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Turkium BlockDAG.
    ...
    /// template is generated for mining in the Turkium BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Turkium BlockDAG.
        ...
        /// structure of the Turkium BlockDAG.
        ...
        GetInfo,
        /// Provides a list of addresses of known peers in the Turkium
        ...
        /// the highest cumulative difficulty in the Turkium BlockDAG.
    ...
    [
        ...
        /// Retrieves the balance of a specific address in the Turkium BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Turkium BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Turkium BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Turkium BlockDAG.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Turkium BlockDAG.
        ...
        /// Resolves a finality conflict in the Turkium BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Turkium network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Turkium network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Turkium network.

//! [`Resolver`](NativeResolver) bindings for obtaining public Turkium wRPC URL endpoints.
...
///
/// Resolver is a client for obtaining public Turkium wRPC URL.
///
/// Resolver queries a list of public Turkium Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Turkium Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Turkium wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Turkium wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Turkium wRPC endpoint for the given encoding and network identifier

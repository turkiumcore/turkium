...
use Turkium_wasm_core::hex::{HexViewConfig, HexViewConfigT};
...
impl ScriptBuilder {
    ...
    /// and any push of data greater than [`MAX_SCRIPT_ELEMENT_SIZE`](Turkium_txscript::MAX_SCRIPT_ELEMENT_SIZE) will not modify
    ...
    /// exceed the maximum allowed script engine size [`MAX_SCRIPTS_SIZE`](Turkium_txscript::MAX_SCRIPTS_SIZE).

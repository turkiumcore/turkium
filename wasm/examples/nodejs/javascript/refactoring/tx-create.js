...
const Turkium = require('../Turkium/Turkium_wasm');
...
Turkium.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"Turkium:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "Turkiumtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("Turkiumtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new Turkium.TransactionOutput(300n, new Turkium.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new Turkium.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];

...
(async () => {
    ...
    console.info(`Full Turkium address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Turkium
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : TurkiumToSompi(0.2)}],
            priorityFee: TurkiumToSompi(0.0001),

Latest online documentation available at: https://Turkium.aspectron.org/docs/
...
- Merge with Rusty Turkium master (0.13.6)
...
- Rename `Turkium-beacon` app to `Turkium-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `Turkium-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://Turkium.aspectron.org/docs/

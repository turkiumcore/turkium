...
class SharedPrefsUtil {
  ...
  // Keys
  static const String first_launch_key = 'fturkium_first_launch';
  static const String auth_method = 'fturkium_auth_method';
  static const String cur_currency = 'fturkium_currency_pref';
  static const String cur_language = 'fturkium_language_pref';
  static const String cur_theme = 'fturkium_theme_pref';
  static const String firstcontact_added = 'fturkium_first_contact_added';
  // If user has seen the root/jailbreak warning yet
  static const String has_shown_root_warning = 'fturkium_root_warn';
  static const String notice_shown = 'fturkium_notice_shown';
  ...
  ThemeSetting getTheme() {
    return ThemeSetting(ThemeOptions.values.byName(get(
      cur_theme,
      defaultValue: ThemeOptions.TURKIUM_DARK.name,
    )));
  }

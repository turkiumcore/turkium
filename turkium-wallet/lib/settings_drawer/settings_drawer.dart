...
class _SettingsSheetState extends ConsumerState<SettingsSheet>
  ...
  Widget buildMainSettings(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      ...
      void contactSupport() =>
          openUrl('mailto:$kSupportEmail?subject=Turkium support');

      void share() {
        Share.share(
          l10n.shareTurkiumText,
          subject: l10n.shareTurkiumSubject,
        );
      }
                ...
                child: Stack(children: [
                  ListView(
                    ...
                    children: [
                      ...
                      // if (network == TurkiumNetwork.mainnet) ...[
                      //   Divider(height: 2, color: theme.text15),
                      //   DoubleLineItem(
                      //     heading: l10n.buyTurkiumTitle,

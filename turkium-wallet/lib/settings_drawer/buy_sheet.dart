...
class BuySettingItem extends SettingSelectionItem {
  ...
  String getDisplayName(BuildContext context) {
    ...
    return l10n.buyTurkiumSubtitle;
  }
}
...
class BuySheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void buyTurkium() {
      ...
      final uri = Uri.https('turkium-topper.vercel.app', '/api/topper', {
        'source': source,
        'target': 'TUR',
      ...
      mainWidget: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              l10n.buyTurkiumMessage + '\n' + l10n.buyTurkiumMessageSecondary,

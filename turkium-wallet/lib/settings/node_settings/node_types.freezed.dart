...
mixin _$NodeConfig {
 ...
 String get id; String get name; bool get isDns; bool get isSecure; List<String> get urls; TurkiumNetwork get network; String get networkSuffix;
...
@useResult
$Res call({
 String id, String name, bool isDns, bool isSecure, List<String> urls, TurkiumNetwork network, String networkSuffix
});
...
as TurkiumNetwork,networkSuffix: null == networkSuffix ? _self.networkSuffix : networkSuffix // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  TurkiumNetwork network,  String networkSuffix)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NodeConfig() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  TurkiumNetwork network,  String networkSuffix)  $default,) {final _that = this;
switch (_that) {
case _NodeConfig():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  bool isDns,  bool isSecure,  List<String> urls,  TurkiumNetwork network,  String networkSuffix)?  $default,) {final _that = this;
switch (_that) {
case _NodeConfig() when $default != null:
return $default(_that.id,_that.name,_that.isDns,_that.isSecure,_that.urls,_that.network,_that.networkSuffix);case _:
  return null;
...
@override final  TurkiumNetwork network;

...
class TurkiumApiSettingsSheet extends HookConsumerWidget {
  const TurkiumApiSettingsSheet({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final apiUrl = ref.watch(turkiumApiUserSetUrlProvider);
    ...
    Future<void> setApiUrl() async {
      ...
      try {
        ...
        final notifier = ref.read(turkiumApiSettingsProvider.notifier);
      ...
      mainWidget: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Set a custom Turkium API URL or leave blank to use the default one.',

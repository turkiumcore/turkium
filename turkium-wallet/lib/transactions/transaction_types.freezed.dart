...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Tx&&const DeepCollectionEquality().equals(other.apiTx, apiTx)&&const DeepCollectionEquality().equals(other.inputData, inputData)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(apiTx),const DeepCollectionEquality().hash(inputData),lastUpdate);
...
/// Create a copy of Tx
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? apiTx = freezed,Object? inputData = null,Object? lastUpdate = null,}) {
  return _then(_self.copyWith(
apiTx: freezed == apiTx ? _self.apiTx : apiTx // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Tx&&const DeepCollectionEquality().equals(other.apiTx, apiTx)&&const DeepCollectionEquality().equals(other._inputData, _inputData)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(apiTx),const DeepCollectionEquality().hash(_inputData),lastUpdate);
...
/// Create a copy of Tx
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? apiTx = freezed,Object? inputData = null,Object? lastUpdate = null,}) {
  return _then(_Tx(
apiTx: freezed == apiTx ? _self.apiTx : apiTx // ignore: cast_nullable_to_non_nullable

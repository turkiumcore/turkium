...
import '../turkium/types.dart';
import '../l10n/l10n.dart';
import '../themes/turkium_light_theme.dart';
...
class MainCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final turkiumBalance = ref.watch(formatedTotalBalanceProvider);
    final fiatBalance = ref.watch(formatedTotalFiatProvider);
    final turkiumPrice = ref.watch(formatedTurkiumPriceProvider);
    ...
    Future<void> scanQrCode() async {
      ...
      final uri = TurkiumUri.tryParse(data, prefix: prefix);
                      ...
                      Container(
                        child: FittedBox(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                'assets/turkium_transparent_180.png',
                                width: 30,
                                color: theme is TurkiumLightTheme
                                    ? theme.primary
                                    : null,
                              ),

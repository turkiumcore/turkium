...
class ReceiveSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final turkiumUri = TurkiumUri(address: receiveAddress.address, amount: amount);
    ...
    Future<void> copyUri() async {
      try {
        await Clipboard.setData(ClipboardData(text: turkiumUri.toString()));
        UIUtil.showSnackbar(l10n.turkiumUriCopied, context);
      } catch (_) {
        UIUtil.showSnackbar(l10n.turkiumUriCopyFailed, context);
      }
    }

...
BoxInfo _genBoxInfo({
  ...
  final addressBoxKey = hash('addressBoxKey#TurkiumNetwork.$networkId#$wid');
  final balanceBoxKey = hash('balanceBoxKey#TurkiumNetwork.$networkId#$wid');
  final utxoBoxKey = hash('utxoBoxKey#TurkiumNetwork.$networkId#$wid');
  final txIndexBoxKey = hash('txIndexBoxKey#TurkiumNetwork.$networkId#$wid');
  final txBoxKey = hash('txBoxKey#TurkiumNetwork.$networkId#$wid');
    ...
    if (!bundle.wasMigrated) {
      ...
      bundle = bundle.copyWith(
        byNetworkId: mainnet != null
            ? {
                ...bundle.byNetworkId,
                kTurkiumNetworkIdMainnet: mainnet,
              }
            : bundle.byNetworkId,
        wasMigrated: true,
      );

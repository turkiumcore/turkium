  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> setupWallet() async {
      try {
        ...
        // address discovery
        final client = ref.read(turkiumClientProvider);
        final api = ref.read(turkiumApiServiceProvider);
        ...
        if (network == TurkiumNetwork.mainnet && !introData.generated) {
              ...
              child: Column(
                ...
                children: [
                  FractionallySizedBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Image.asset('assets/turkium.png'),
                    ),
                  ),
                  Column(
                    children: [

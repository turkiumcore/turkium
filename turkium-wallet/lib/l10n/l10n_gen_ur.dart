...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get insufficientBalanceDetails =>
      'آپ کے پاس اس لین دین کے لیے کافی TUR نہیں ہے';
  ...
  @override
  String get turkiumDevFund => 'کاسپا دیو فنڈ';
  ...
  @override
  String get turkiumWallet => 'کاسپیم بٹوا ';
  ...
  @override
  String get nodeDeleteTitle => 'Turkium Node Config کو حذف کریں؟';
  ...
  @override
  String get shareTurkium => 'Turkium کا اشتراک کریں۔';

  @override
  String get shareTurkiumSubject => 'Turkium Wallet چیک کریں۔';

  @override
  String get shareTurkiumText =>
      'Turkium - Turkium Mobile Wallet  ویب سائٹ - turkium.io چیک کریں۔';
  ...
  String transferComplete(String amount) {
    return '$amount TUR کامیابی کے ساتھ آپ کے Turkium Wallet میں منتقل ہو گیا۔\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount TUR کے بیلنس والے پرس کا پتہ چلا ہے۔';
  }
  ...
  String transferIntro(String button) {
    return 'یہ عمل کاغذی بٹوے سے آپ کے Turkium والیٹ میں رقم منتقل کر دے گا۔\n\n شروع کرنے کے لیے \"$button\" بٹن کو تھپتھپائیں  ۔';
  }
  ...
  @override
  String get transferNoFunds => 'اس سیڈ پر کوئی TUR نہیں ہے۔';

  @override
  String get transferQrScanError => 'اس QR کوڈ میں درست سیڈ نہیں ہے۔';

  @override
  String get transferQrScanHint => 'Turkium سیڈ یا نجی کلید اسکین کریں۔';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!یہ \n\n  Turkium کا ورژن $version ہے - Turkium کے لیے موبائل والیٹ';
  }

  @override
  String get welcomeText =>
      'Turkium میں خوش آمدید۔ شروع کرنے کے لیے، آپ ایک نیا پرس بنا سکتے ہیں یا پہلے سے موجود کو درآمد کر سکتے ہیں۔';

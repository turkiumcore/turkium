...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get aboutTopperDescription =>
      'আপহোল্ড দ্বারা টপার হল ফিয়াট থেকে ক্রিপ্টো অনরাম্প যা ব্যবহারকারীদের ক্রেডিট/ডেবিট কার্ড ব্যবহার করে বা ব্যাঙ্ক অ্যাকাউন্টের মাধ্যমে ক্রিপ্টোকারেন্সি কিনতে দেয়।';

  @override
  String get aboutTopperTitle => 'টপার সম্পর্কে';
  ...
  @override
  String get addNodeFailed => 'Turkium নোড যোগ করা ব্যর্থ হয়েছে';
  ...
  @override
  String get buyTurkiumMessage => 'দ্রুত এবং সহজে \$TUR কিনুন।';

  @override
  String get buyTurkiumMessageSecondary =>
      'টপার, আপহোল্ডের ফিয়াট-টু-ক্রিপ্টো অনর্যাম্প দ্বারা সরবরাহ করা পরিষেবা।';

  @override
  String get buyTurkiumSubtitle => 'আপহোল্ড দ্বারা টপার এর মাধ্যমে';

  @override
  String get buyTurkiumTitle => 'কাসপা কিনুন';
  ...
  @override
  String get compoundRequired => 'কম্পাউন্ড এর প্রয়োজন';

  @override
  String get compoundRequiredDescription =>
      'লেনদেনের পরিমাণের জন্য অনেক বেশি UTXO প্রয়োজন৷ চক্রবৃদ্ধি UTXO-এর সংখ্যা কমিয়ে দেবে।';
  ...
  @override
  String get copyKpub => 'Kpub কপি করুন';
  ...
  @override
  String get enterFiatValue => 'ফিয়াট মূল্য লিখুন';
  ...
  String get insufficientBalanceDetails =>
      'এই লেনদেনের জন্য আপনার কাছে পর্যাপ্ত TUR নেই';
  ...
  @override
  String get invalidSecretPhrase => 'অবৈধ গোপন বাক্যাংশ';

  @override
  String get invalidSecretPhraseConfirmation => 'আমি জানি আমি কি করছি';

  @override
  String get invalidSecretPhraseDetails =>
      'আপনার প্রবেশ করানো গোপন বাক্যাংশে একটি অবৈধ চেকসাম রয়েছে৷';

  @override
  String get turkiumDevFund => 'কাসপা ডেভ তহবিল';

  @override
  String get turkiumUriCopied => 'কাসপা URI কপি করা হয়েছে';

  @override
  String get turkiumUriCopyFailed => 'Turkium URI কপি করতে ব্যর্থ হয়েছে';

  @override
  String get turkiumUriInvalid => 'অবৈধ Turkium URI';

  @override
  String get turkiumWallet => 'কাস্পিয়াম ওয়ালেট';

  @override
  String get kpubAuth => 'এক্সটেন্ডেড পাবলিক কী দেখুন';

  @override
  String get kpubCopied => 'এক্সটেন্ডেড পাবলিক কী কপি করা হয়েছে৷';

  @override
  String get kpubCopyFailed => 'এক্সটেন্ডেড পাবলিক কী কপি করতে ব্যর্থ হয়েছে৷';

  @override
  String get kpubDescription =>
      'এক্সটেন্ডেড সর্বজনীন কী আপনার ওয়ালেটকে শুধু ওয়াচ ওয়ালেট হিসাবে আমদানি করতে ব্যবহার করা যেতে পারে।';

  @override
  String get kpubTitle => 'এক্সটেন্ডেড পাবলিক কী';
  ...
  @override
  String get noteLabel => 'দ্রষ্টব্য:';
  ...
  @override
  String get sentTo => 'পাঠানো হয়েছে';
  ...
  @override
  String get shareTurkium => 'কাসপিয়াম শেয়ার করুন';

  @override
  String get shareTurkiumSubject => 'কাসপিয়াম ওয়ালেট চেক আউট';

  @override
  String get shareTurkiumText =>
      'কাসপিয়াম - কাসপা মোবাইল ওয়ালেট দেখুন।\nওয়েবসাইট - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR সফলভাবে আপনার Turkium Wallet এ স্থানান্তরিত হয়েছে৷৷\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount TUR ব্যালেন্স সহ একটি ওয়ালেট সনাক্ত করা হয়েছে৷';
  }
  ...
  String transferIntro(String button) {
    return 'এই প্রক্রিয়াটি পেপার ওয়ালেট থেকে আপনার Turkium ওয়ালেটে তহবিল স্থানান্তর করবে।\n\nশুরু করতে \"$button\" বোতামে ট্যাপ করুন।';
  }
  ...
  @override
  String get transferNoFunds => 'এই সিড এ কোন TUR নেই';
  ...
  @override
  String get txFilterDialogOptionAllTxs => 'সমস্ত লেনদেন দেখান';

  @override
  String get txFilterDialogOptionHideNotAcceptedCoinbase =>
      'লুকান অগৃহীত কয়েনবেস এর লেনদেন ';

  @override
  String get txFilterDialogTitle => 'লেনদেন ফিল্টার';
  ...
  @override
  String get txReport => 'লেনদেন এর রিপোর্ট';

  @override
  String get txReportDate => 'তারিখ';

  @override
  String get txReportDescription => 'বর্ণনা';

  @override
  String get txReportDetails =>
      'একটি লেনদেন প্রতিবেদন তৈরি করুন, CSV ফর্ম্যাটে, যাতে সমস্ত ওয়ালেটের লেনদেনের ইতিহাস থাকবে৷';

  @override
  String get txReportError => 'রিপোর্ট তৈরি করতে৷';

  @override
  String get txReportFeeAmount => 'ফি পরিমাণ';

  @override
  String get txReportFeeCurrency => 'ফি মুদ্রা';

  @override
  String get txReportFeeForCompound => 'কম্পাউন্ড লেনদেনের জন্য ফি';

  @override
  String get txReportFeeForSelfSend => 'নিজস্ব ঠিকানায় পাঠাতে ফি';

  @override
  String get txReportGenerate => 'তৈরি করুন';

  @override
  String get txReportGetReport => 'রিপোর্ট পান';

  @override
  String get txReportLabel => 'লেবেল';

  @override
  String get txReportLabelCost => 'খরচ';

  @override
  String txReportNoLoadedTxs(int loadedTxs, int totalTxs) {
    return '($totalTxs এর মধ্যে $loadedTxs)';
  }

  @override
  String get txReportNote => 'দ্রষ্টব্য';

  @override
  String txReportNoTxs(int numberOf) {
    return '$numberOfটি লেনদেন পাওয়া গেছে।';
  }

  @override
  String get txReportOptionIgnoreCompound => 'কম্পাউন্ড লেনদেন উপেক্ষা করুন';

  @override
  String get txReportOptionIgnoreSelfTxs =>
      'নিজের কাছে পাঠানো লেনদেন উপেক্ষা করুন';

  @override
  String get txReportOptionRefreshTxs => 'রিফ্রেশ লেনদেন';

  @override
  String get txReportReceivedAmount => 'প্রাপ্তির পরিমাণ';

  @override
  String get txReportReceivedCurrency => 'প্রাপ্ত মুদ্রা';

  @override
  String get txReportSentAmount => 'প্রেরিত পরিমাণ';

  @override
  String get txReportSentCurrency => 'প্রেরিত মুদ্রা';

  @override
  String get txReportStatusLoading => 'লেনদেন লোড হচ্ছে';

  @override
  String get txReportStatusReady => 'লেনদেন রিপোর্ট প্রস্তুত!';

  @override
  String get txReportStatusRefreshing => 'রিফ্রেশিং লেনদেন';

  @override
  String get txReportSubtitle => 'লেনদেনের ইতিহাস সহ CSV ফাইল পান';
  ...
  @override
  String get walletAddress => 'ওয়ালেট এড্রেস';
  ...
  String walletAddressesCopied(String addressType) {
    return 'ওয়ালেট $addressType ঠিকানা ক্লিপবোর্ডে কপি করা হয়েছে৷';
  }

  @override
  String walletAddressesCopyFailed(String addressType) {
    return 'ওয়ালেট $addressType এড্রেস কপি করতে ব্যর্থ হয়েছে৷';
  }

...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Misslyckades att lägga till en Turkium nod';
  ...
  String get insufficientBalanceDetails =>
      'Du har inte nog med TUR för att genomföra transaktionen';
  ...
  @override
  String get turkiumDevFund => 'Turkiums utvecklingsfond';
  ...
  @override
  String get turkiumUriInvalid => 'Invalid Turkium URI';

  @override
  String get turkiumWallet => 'Turkium plånbok';
  ...
  @override
  String get nodeAddress => 'Turkium nod';

  @override
  String get nodeDeleteMessage => 'Är du säker på att du vill radera?';

  @override
  String get nodeDeleteTitle => 'Radera Turkium nod konfiguration?\n';
  ...
  @override
  String get nodesSheetTitle => 'Turkium noder';
  ...
  String get passwordNoLongerRequiredToOpenParagraph =>
      'Du kommer inte behöva ett lösenord för att öppna Turkium längre.';
  ...
  String get passwordWillBeRequiredToOpenParagraph =>
      'Lösenordet behövs för att öppna Turkium.';
  ...
  String get requireAPasswordToOpenHeader =>
      'Kräv lösenord för att öppna Turkium?';
  ...
  @override
  String get shareTurkium => 'Dela Turkium';

  @override
  String get shareTurkiumSubject => 'Kolla in Turkium plånboken';

  @override
  String get shareTurkiumText =>
      'Prova Turkium! Turkiums mobila plånbok. Webbsida - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR har överförts till din Turkium-plånbok.';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'En plånbok med ett saldo på $amount TUR har upptäckts.\n';
  }
  ...
  String transferIntro(String button) {
    return 'Den här processen kommer att överföra tillgångar från en pappersplånbok till din Turkium-plånbok.\n\nTryck på \"$button\" knappen för att starta.';
  }
  ...
  @override
  String get transferNoFunds => 'Detta seed innehåller inga TUR.';
  ...
  @override
  String get unlockBiometrics => 'Verifiera för att låsa upp Turkium';

  @override
  String get unlockPin => 'Ange PIN för att låsa upp Turkium';
  ...
  String welcomeMessage(String version) {
    return 'Välkommen! Det här är version $version för Turkium - den mobila appen för Turkium';
  }

  @override
  String get welcomeText =>
      'Välkommen till Turkium. För att fortsätta så behöver du skapa en ny plånbok eller importera en befintlig plånbok.';

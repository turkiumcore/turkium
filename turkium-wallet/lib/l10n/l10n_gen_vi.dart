...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Failed to add Turkium node';
  ...
  String get exampleCardIntro =>
      'Chào mừng đến với Turkium. Khi bạn nhận Turkium, các giao dịch sẽ được hiển thị như sau:';
  ...
  @override
  String get nodeDeleteTitle => 'Delete Turkium Node Config?';
  ...
  String get passwordNoLongerRequiredToOpenParagraph =>
      'Bạn sẽ không cần mật khẩu để mở Turkium nữa.';
  ...
  String get passwordWillBeRequiredToOpenParagraph =>
      'Mật khẩu này sẽ được yêu cầu để mở Turkium.';
  ...
  @override
  String get requireAPasswordToOpenHeader => 'Yêu cầu mật khẩu để mở Turkium?';
  ...
  @override
  String get shareTurkium => 'Chia sẻ Turkium';

  @override
  String get shareTurkiumSubject => 'Check out Turkium Wallet';

  @override
  String get shareTurkiumText =>
      'Thử ngay Turkium! Ví Turkium di động chính thức!';
  ...
  String transferComplete(String amount) {
    return '$amount Turkium đã được chuyển vào ví Turkium của bạn.\n';
  }
  ...
  String transferIntro(String button) {
    return 'Quá trình này sẽ chuyển toàn bộ số dư từ ví giấy sang ví Turkium của bạn.\n\nNhấn nút \"$button\" để bắt đầu.';
  }
  ...
  @override
  String get transferNoFunds => 'Hạt giống này không chứa chút Turkium nào';
  ...
  String get transferQrScanHint =>
      'Quét \nhạt giống Turkium hoặc khoá riêng tư';
  ...
  @override
  String get unlockBiometrics => 'Xác nhận mở khoá Turkium';

  @override
  String get unlockPin => 'Nhập mã PIN để mở khoá Turkium';
  ...
  String get welcomeText =>
      'Chào mừng đến với Turkium. Để bắt đầu, bạn có thể tạo ví mới hoặc nhập ví hiện có.';

...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get buyTurkiumMessage => 'Купете \$TUR лесно и бързо.';
  ...
  @override
  String get buyTurkiumSubtitle => 'Чрез Topper от Uphold';

  @override
  String get buyTurkiumTitle => 'Купи Turkium';
  ...
  String get insufficientBalanceDetails =>
      'Нямате достатъчно TUR за тази транзакция';
  ...
  @override
  String get turkiumUriCopied => 'Turkium URI е копиран';

  @override
  String get turkiumUriCopyFailed => 'Неуспешно копиране на Turkium URI';

  @override
  String get turkiumUriInvalid => 'Невалиден Turkium URI';
  ...
  @override
  String get nodeDeleteTitle => 'Изтриване на конфигурацията за Turkium нода?';
  ...
  @override
  String get nodesSheetTitle => 'Turkium нодове';
  ...
  @override
  String get shareTurkium => 'Споделете Turkium';

  @override
  String get shareTurkiumSubject => 'Виж повече за Turkium портфейл';

  @override
  String get shareTurkiumText =>
      'Научете повече за Turkium - Официалният Turkium мобилен портфейл. \nУебсайт - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR успешно прехвърлени към вашия Turkium портфейл.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Портфейл с баланс от $amount TUR е открит.';
  }
  ...
  String transferIntro(String button) {
    return 'Този процес ще прехвърли вашите средства от Paper Wallet към Turkium Wallet.\n\nНатиснете \"$button\" бутона за старт.';
  }
  ...
  @override
  String get transferNoFunds => 'Този seed не съдържа TUR';

  @override
  String get transferQrScanError => 'Този QR код не съдържа валиден seed.';

  @override
  String get transferQrScanHint => 'Сканирайте Turkium \nseed или частен ключ';
  ...
  String welcomeMessage(String version) {
    return 'Добре дошли!\n\nТова е версия $version на Turkium - мобилният портфейл за Turkium';
  }

  @override
  String get welcomeText =>
      'Добре дошли в Turkium. За да започнете, създайте нов портфейл или импортирайте вече съществуващ такъв.';

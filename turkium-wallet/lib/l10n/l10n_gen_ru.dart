...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Не удалось добавить ноду Turkium';
  ...
  String get insufficientBalanceDetails =>
      'У вас не хватает TUR для этой транзакции';
  ...
  @override
  String get turkiumDevFund => 'Фонд разработки Каспы';
  ...
  @override
  String get turkiumUriInvalid => 'Недействительный URI Turkium';

  @override
  String get turkiumWallet => 'Кошелёк Turkium';
  ...
  @override
  String get nodeAddress => 'Нода Turkium';

  @override
  String get nodeDeleteMessage => 'Вы уверены, что хотите удалить?';

  @override
  String get nodeDeleteTitle => 'Удалить конфигурацию ноды Turkium?';
  ...
  @override
  String get nodesSheetTitle => 'Ноды Turkium';
  ...
  @override
  String get shareTurkium => 'Поделиться Turkium';

  @override
  String get shareTurkiumSubject => 'Попробуйте кошелёк Turkium';

  @override
  String get shareTurkiumText =>
      'Попробуйте Turkium - мобильный кошелёк Turkium.\nВеб-сайт - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR успешно переведено в кошелёк Turkium.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Обнаружен кошелёк с балансом $amount TUR.';
  }
  ...
  String transferIntro(String button) {
    return 'Этот процесс переведёт средства с бумажного кошелька на ваш кошелёк Turkium.\n\nНажмите кнопку \"$button\" чтобы начать.';
  }
  ...
  @override
  String get transferNoFunds => 'Эта seed-фраза не имеет TUR.';
  ...
  String welcomeMessage(String version) {
    return 'Добро пожаловать!\n\nЭто версия $version Turkium - мобильного кошелька Turkium';
  }

  @override
  String get welcomeText =>
      'Добро пожаловать в Turkium. Вы можете создать новый кошелек или импортировать уже существующий.';

...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get buyTurkiumMessage => 'TUR\$ را سریع و آسان بخرید.';
  ...
  @override
  String get buyTurkiumSubtitle => 'Via Topper توسط Uphold';

  @override
  String get buyTurkiumTitle => 'خرید Turkium';
  ...
  String get insufficientBalanceDetails =>
      'شما TUR کافی برای این تراکنش ندارید';
  ...
  @override
  String get turkiumDevFund => 'صندوق توسعه دهندگان Turkium';

  @override
  String get turkiumUriCopied => 'Turkium URI کپی شد';

  @override
  String get turkiumUriCopyFailed => 'Turkium URI کپی نشد';

  @override
  String get turkiumUriInvalid =>
      ' Turkium URI یا شناسه منبع یکپارچه Turkium نامعتبر است';

  @override
  String get turkiumWallet => 'کیف پول Turkium';
  ...
  @override
  String get nodeAddress => 'نود Turkium';

  @override
  String get nodeDeleteMessage => 'آیا مطمئن هستید که می خواهید حذف کنید؟';

  @override
  String get nodeDeleteTitle => 'پیکربندی نود Turkium حذف شود؟';
  ...
  @override
  String get nodesSheetTitle => 'نودهای Turkium';
  ...
  @override
  String get shareTurkium => 'اشتراک گذاری Turkium';

  @override
  String get shareTurkiumSubject => 'بررسی کیف پول Turkium';

  @override
  String get shareTurkiumText =>
      'بررسی Turkium - کیف پول موبایلی Turkium\nوبسایت - turkium.io';
  ...
  String transferComplete(String amount) {
    return 'تعداد $amount TUR با موفقیت به کیف پول Turkium شما منتقل شد.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'کیف پولی با موجودی $amount TUR شناسایی شد.';
  }
  ...
  String transferIntro(String button) {
    return 'این فرآیند وجوه را از کیف پول کاغذی به کیف پول Turkium شما منتقل خواهد کرد.\n\nبرای شروع، \"$button\" را لمس کنید.';
  }
  ...
  @override
  String get transferNoFunds => 'این seed شامل هیچ TUR نمی باشد';

  @override
  String get transferQrScanError => 'این QR کد شامل هیچ seed معتبری نیست.';

  @override
  String get transferQrScanHint => 'اسکن Turkium\nseed یا کلید خصوصی';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!\n\nاین نسخه شماره $version Turkium است - کیف پول موبایلی Turkium';
  }

  @override
  String get welcomeText =>
      'به Turkium خوش آمدید. برای شروع، می توانید یک کیف پول جدید بسازید یا کیف پول موجود را وارد کنید.';

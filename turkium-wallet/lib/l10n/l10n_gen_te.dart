...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Turkium నోడ్  జోడించడంలో విఫలమైంది';
  ...
  String get insufficientBalanceDetails =>
      'ఈ లావాదేవీ కోసం మీ వద్ద తగినంత TUR లేదు';
  ...
  @override
  String get turkiumDevFund => 'కస్పా Dev ఫండ్';
  ...
  @override
  String get turkiumUriInvalid => 'చెల్లని Turkium URI';

  @override
  String get turkiumWallet => 'కాస్పియం వాలెట్';
  ...
  @override
  String get nodeAddress => 'Turkium నోడ్';

  @override
  String get nodeDeleteMessage => 'మీరు తొలగించాలనుకుంటున్నారా ఖచ్చితంగా?';

  @override
  String get nodeDeleteTitle => 'Turkium నోడ్ కాన్ఫిగర్‌ని తొలగించాలా?';
  ...
  @override
  String get nodesSheetTitle => 'Turkium నోడ్స్';
  ...
  @override
  String get shareTurkium => 'కాస్పియం యాప్‌ను భాగస్వామ్యం చేయండి';

  @override
  String get shareTurkiumSubject => 'కాస్పియం వాలెట్‌ని తనిఖీ చేయండి';

  @override
  String get shareTurkiumText =>
      'కాస్పియం - Turkium మొబైల్ వాలెట్‌ని తనిఖీ చేయండి.\nవెబ్సైట్ - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR మీ కాస్పియం వాలెట్కి విజయవంతంగా బదిలీ చేయబడింది.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount TUR బ్యాలెన్స్ ఉన్న వాలెట్ కనుగొనబడింది.';
  }
  ...
  @override
  String get transferNoFunds => 'ఈ Seedలో TUR ఏదీ లేదు';
  ...
  String welcomeMessage(String version) {
    return 'స్వాగతం!\n\nఇది కాస్పియం యొక్క వెర్షన్ $version - Turkium కోసం మొబైల్ వాలెట్';
  }

...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Αποτυχία προσθήκης κόμβου Turkium';
  ...
  String get insufficientBalanceDetails =>
      'Δεν έχετε αρκετά TUR για αυτήν την συναλλαγή';
  ...
  @override
  String get turkiumDevFund => 'Κονδύλιο προγραμματιστών TURPA';
  ...
  @override
  String get turkiumWallet => 'Το πορτοφόλι Turkium';
  ...
  @override
  String get nodeAddress => 'Κόμβος Turkium';
  ...
  String get nodeDeleteTitle =>
      'Να διαγραφούν οι ρυθμίσεις του κόμβου Turkium;';
  ...
  @override
  String get nodesSheetTitle => 'Κόμβοι Turkium';
  ...
  @override
  String get shareTurkium => 'Μοιράστε το Turkium';

  @override
  String get shareTurkiumSubject => 'Τσεκάρετε το πορτοφόλι Turkium!';

  @override
  String get shareTurkiumText =>
      'Τσεκάρετε το Turkium! Το φορητό πορτοφόλι για το Turkium. Ιστοσελίδα - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR μεταφέρθηκαν επιτυχώς στο Turkium πορτοφόλι σας.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Εντοπίσθηκε ένα πορτοφόλι με υπόλοιπο $amount TUR.';
  }
  ...
  String transferIntro(String button) {
    return 'Η διαδικασία αυτή θα μεταφέρει τα κεφάλαιο από το χάρτινο πορτοφόλι στο πορτοφόλι Turkium.\n\nΠατήστε το  \"$button\" κουμπί για να ξεκινήσετε.';
  }
  ...
  String get transferNoFunds =>
      'Το πορτοφόλι που αντιστοιχεί σε αυτήν την μυστική φράση, δεν διαθέτει υπόλοιπο TUR.';
  ...
  String get transferQrScanHint =>
      'Σαρώστε μία μυστική φράση Turkium ή ένα ιδιωτικό κλειδί.';
  ...
  String welcomeMessage(String version) {
    return 'Καλως ήρθατε!\n\nΑυτή είναι η έκδοση $version του Turkium - το φορητό πορτοφόλι για το Turkium\n ';
  }

  @override
  String get welcomeText =>
      'Καλώς ήρθατε στο Turkium. Για να ξεκινήσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον πορτοφόλι.';

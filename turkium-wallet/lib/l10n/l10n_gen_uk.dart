...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Помилка додавання ноди Turkium';
  ...
  String get insufficientBalanceDetails =>
      'У вас недостатньо TUR для даної транзакції';
  ...
  @override
  String get turkiumDevFund => 'Фонд розвитку Turkium';
  ...
  @override
  String get turkiumUriInvalid => 'Невірний URI Turkium';

  @override
  String get turkiumWallet => 'Гаманець Turkium';
  ...
  @override
  String get nodeDeleteTitle => 'Видалити конфігурацію ноди Turkium?';
  ...
  @override
  String get nodesSheetTitle => 'Ноди Turkium';
  ...
  @override
  String get shareTurkium => 'Поділитися Turkium';

  @override
  String get shareTurkiumSubject => 'Спробуйте гаманець Turkium';

  @override
  String get shareTurkiumText =>
      'Спробуйте Turkium - мобільний гаманець Turkium.\nВебсайт - turkium.io';
  ...
  String transferComplete(String amount) {
    return '$amount TUR успішно перераховано до вашого гаманця Turkium. \n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Виявлено гаманець з балансом $amount TUR.';
  }
  ...
  String transferIntro(String button) {
    return 'Цей процес перенесе кошти з паперового гаманця у ваш гаманець Turkium.\n\nНатисніть кнопку \"$button\", щоб почати.';
  }
  ...
  @override
  String get transferNoFunds => 'Ця seed-фраза не містить TUR на балансі.';
  ...
  String welcomeMessage(String version) {
    return 'Ласкаво просимо!\n\nЦе версія $version Turkium - мобільного гаманця Turkium.';
  }

  @override
  String get welcomeText =>
      'Вітаємо в Turkium. Щоб розпочати, створіть новий гаманець або імпортуйте існуючий.';

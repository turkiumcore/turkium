...
abstract class AppLocalizations {
  ...
  /// No description provided for @buyTurkiumMessage.
  ///
  /// In en, this message translates to:
  /// **'Buy \$TUR quickly & easily.'**
  String get buyTurkiumMessage;

  /// No description provided for @buyTurkiumMessageSecondary.
  ///
  /// In en, this message translates to:
  /// **'Service provided by Topper, Uphold\'s fiat-to-crypto onramp.'**
  String get buyTurkiumMessageSecondary;

  /// No description provided for @buyTurkiumSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Via Topper by Uphold'**
  String get buyTurkiumSubtitle;

  /// No description provided for @buyTurkiumTitle.
  ///
  /// In en, this message translates to:
  /// **'Buy Turkium'**
  String get buyTurkiumTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'You don\'t have enough TUR for this transaction'**
  ...
  /// No description provided for @turkiumDevFund.
  ///
  /// In en, this message translates to:
  /// **'Turkium Dev Fund'**
  String get turkiumDevFund;

  /// No description provided for @turkiumUriCopied.
  ///
  /// In en, this message translates to:
  /// **'Turkium URI Copied'**
  String get turkiumUriCopied;

  /// No description provided for @turkiumUriCopyFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to copy Turkium URI'**
  String get turkiumUriCopyFailed;

  /// No description provided for @turkiumUriInvalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid Turkium URI'**
  String get turkiumUriInvalid;

  /// No description provided for @turkiumWallet.
  ///
  /// In en, this message translates to:
  /// **'Turkium Wallet'**
  String get turkiumWallet;
  ...
  /// No description provided for @shareTurkium.
  ///
  /// In en, this message translates to:
  /// **'Share Turkium'**
  String get shareTurkium;

  /// No description provided for @shareTurkiumSubject.
  ///
  /// In en, this message translates to:
  /// **'Check out Turkium Wallet'**
  String get shareTurkiumSubject;

  /// No description provided for @shareTurkiumText.
  ///
  /// In en, this message translates to:
  /// **'Check out Turkium - Turkium Mobile Wallet.\nWebsite - turkium.io'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{amount} TUR successfully transferred to your Turkium Wallet.\n'**
  String transferComplete(String amount);

  /// No description provided for @transferConfirmInfo.
  ///
  /// In en, this message translates to:
  /// **'A wallet with a balance of {amount} TUR has been detected.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This process will transfer the funds from a paper wallet to your Turkium wallet.\n\nTap the \"{button}\" button to start.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This seed does not have any TUR on it'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome!\n\nThis is version {version} of Turkium - the mobile wallet for Turkium'**
  String welcomeMessage(String version);

  /// No description provided for @welcomeText.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Turkium. To begin, you may create a new wallet or import an existing one.'**

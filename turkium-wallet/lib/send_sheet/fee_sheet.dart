...
import '../widgets/turkium_icon_widget.dart';
...
class FeeSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void onValueChanged(String text) {
      final value = turkiumFormatter.tryParse(text);
        ...
        children: [
          ...
          FiatValueContainer(
            ...
            child: AppTextField(
              ...
              inputFormatters: [turkiumFormatter],
              onChanged: onValueChanged,
              textInputAction: TextInputAction.done,
              maxLines: null,
              autocorrect: false,
              hintText: hint.value ?? l10n.feePriorityHint,
              prefixButton: TextFieldButton(widget: TurkiumIconWidget()),

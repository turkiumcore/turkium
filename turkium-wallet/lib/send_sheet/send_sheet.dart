...
class _SendSheetState extends ConsumerState<SendSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> scanQrCode() async {
      ...
      final prefix = ref.read(addressPrefixProvider);
      final uri = TurkiumUri.tryParse(qrData, prefix: prefix);
  ...
  Widget getEnterAmountContainer() {
    return HookConsumer(builder: (context, ref, _) {
      ...
      final turkiumFormatter = ref.watch(turkiumFormatterProvider);
      ...
      void onValueChanged(String text) {
        final value = switch (fiatMode) {
          true => () {
              final price = ref.read(turkiumPriceProvider);
          ...
          false => turkiumFormatter.tryParse(text),
        };
      ...
      return FiatValueContainer(
        ...
        child: AppTextField(
          ...
          inputFormatters: [fiatMode ? fiatFormatter : turkiumFormatter],

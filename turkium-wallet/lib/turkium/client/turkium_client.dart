...
class VoidTurkiumClient extends TurkiumClient {
  VoidTurkiumClient()
      : super(
...
class TurkiumClient {
  ...
  TurkiumClient({required this.channel}) : rpcClient = RPCClient(channel);

  factory TurkiumClient.url(String url, {bool isSecure = false}) {
    ...
    return TurkiumClient(channel: channel);
  }

...
String convertIfXpub(String hdPubKey) {
  if (hdPubKey.startsWith('xpub')) {
    try {
      ...
      bip32.network = networkTypeForNetwork(TurkiumNetwork.mainnet);
...
String convertTurkiumHdPublicKey(String hdPubKey, TurkiumNetwork toNetwork) {
...
AddressPrefix addressPrefixForNetwork(TurkiumNetwork network) {
  switch (network) {

...
@freezed
sealed class TurkiumUriParam with _$TurkiumUriParam {
  const TurkiumUriParam._();
  const factory TurkiumUriParam({
    required String key,
...
@freezed
sealed class TurkiumUri with _$TurkiumUri {
  const TurkiumUri._();
  const factory TurkiumUri({
    required Address address,
    Amount? amount,
    String? label,
    String? message,
    @Default(const IListConst([])) IList<TurkiumUriParam> others,
  }) = _TurkiumUri;

  static TurkiumUri parse(
    String uri, {
    ...
    for (final param in params) {
      ...
      switch (key) {
        ...
        case kMessageKey:
          ...
          break;
        default:
          others.add(TurkiumUriParam(key: key, value: value));
      }
    }
  ...
  Iterable<TurkiumUriParam> get requiredParams =>

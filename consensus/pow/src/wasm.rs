...
use Turkium_consensus_client::Header;
use Turkium_consensus_client::HeaderT;
use Turkium_consensus_core::hashing;
use Turkium_hashes::Hash;
use Turkium_hashes::PowHash;
use Turkium_math::Uint256;
use Turkium_utils::hex::FromHex;
...
/// Represents a Turkium header PoW manager
/// @category Mining
...
// https://github.com/tmrlvi/Turkium-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L36
...
/// <https://github.com/tmrlvi/Turkium-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category Mining

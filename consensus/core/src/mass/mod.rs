...
pub struct UtxoCell {
    ...
    pub plurality: u64,
    /// The amount of TURK (in sompis) locked in this UTXO
    pub amount: u64,
}
...
// `turkium_wallet_core::tx::mass::MassCalculator`
#[derive(Clone)]
...
mod tests {
    use super::*;
    use crate::{
        constants::{SOMPI_PER_TURKIUM, STORAGE_MASS_PARAMETER},
        network::NetworkType,
    ...
    fn test_storage_mass_pluralities() {
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                name: "1:3; output index=1, plurality=2; turk units",
                inputs_tx1: &[1000 * SOMPI_PER_TURKIUM],
                outputs_tx1: &[200 * SOMPI_PER_TURKIUM, 200 * SOMPI_PER_TURKIUM, 200 * SOMPI_PER_TURKIUM],
                inputs_tx2: &[1000 * SOMPI_PER_TURKIUM],
                outputs_tx2: &[200 * SOMPI_PER_TURKIUM, 400 * SOMPI_PER_TURKIUM],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "1:2; output index=0, plurality=2; turk units",
                inputs_tx1: &[1000 * SOMPI_PER_TURKIUM],
                outputs_tx1: &[200 * SOMPI_PER_TURKIUM, 200 * SOMPI_PER_TURKIUM],
                inputs_tx2: &[1000 * SOMPI_PER_TURKIUM],
                outputs_tx2: &[400 * SOMPI_PER_TURKIUM],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "2:2; output index=0, plurality=2; turk units",
                inputs_tx1: &[350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM],
                outputs_tx1: &[200 * SOMPI_PER_TURKIUM, 200 * SOMPI_PER_TURKIUM],
                inputs_tx2: &[350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM],
                outputs_tx2: &[400 * SOMPI_PER_TURKIUM],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
            ...
            PluralityTestCase {
                name: "4:6; output index=0, plurality=3; turk units",
                inputs_tx1: &[350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM, 350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM],
                outputs_tx1: &[
                    200 * SOMPI_PER_TURKIUM,
                    200 * SOMPI_PER_TURKIUM,
                    400 * SOMPI_PER_TURKIUM,
                    250 * SOMPI_PER_TURKIUM,
                    250 * SOMPI_PER_TURKIUM,
                    250 * SOMPI_PER_TURKIUM,
                ],
                inputs_tx2: &[350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM, 350 * SOMPI_PER_TURKIUM, 500 * SOMPI_PER_TURKIUM],
                outputs_tx2: &[200 * SOMPI_PER_TURKIUM, 200 * SOMPI_PER_TURKIUM, 400 * SOMPI_PER_TURKIUM, 750 * SOMPI_PER_TURKIUM],
    ...
    fn test_storage_mass() {
        ...
        let base_value = 10_000 * SOMPI_PER_TURKIUM;
        ...
        tx2.tx.outputs[0].value = 10 * SOMPI_PER_TURKIUM;

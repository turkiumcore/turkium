...
/// SompiPerTurkium is the number of sompi in one Turkium (1 TURK).
pub const SOMPI_PER_TURKIUM: u64 = 100_000_000;

/// The parameter for scaling inverse Turkium value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_TURKIUM * 10_000;
...
pub const MAX_SOMPI: u64 = 29_000_000_000 * SOMPI_PER_TURKIUM;

...
/// The maximum number of addresses that are sent in a single Turkium Addresses message.
const MAX_ADDRESSES_SEND: usize = 1000;

/// The maximum number of addresses that can be received in a single Turkium Addresses response.

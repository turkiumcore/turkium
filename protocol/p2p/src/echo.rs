use crate::{
    IncomingRoute, Router, TurkiumdMessagePayloadType,
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            TurkiumdMessagePayloadType::Addresses,
            TurkiumdMessagePayloadType::Block,
            TurkiumdMessagePayloadType::Transaction,
            TurkiumdMessagePayloadType::BlockLocator,
            TurkiumdMessagePayloadType::RequestAddresses,
            TurkiumdMessagePayloadType::RequestRelayBlocks,
            TurkiumdMessagePayloadType::RequestTransactions,
            TurkiumdMessagePayloadType::IbdBlock,
            TurkiumdMessagePayloadType::InvRelayBlock,
            TurkiumdMessagePayloadType::InvTransactions,
            TurkiumdMessagePayloadType::Ping,
            TurkiumdMessagePayloadType::Pong,
            // TurkiumdMessagePayloadType::Verack,
            // TurkiumdMessagePayloadType::Version,
            // TurkiumdMessagePayloadType::Ready,
            TurkiumdMessagePayloadType::TransactionNotFound,
            TurkiumdMessagePayloadType::Reject,
            TurkiumdMessagePayloadType::PruningPointUtxoSetChunk,
            TurkiumdMessagePayloadType::RequestIbdBlocks,
            ...
            TurkiumdMessagePayloadType::RequestNextHeaders,
            TurkiumdMessagePayloadType::DoneHeaders,
            TurkiumdMessagePayloadType::RequestPruningPointUtxoSet,
            TurkiumdMessagePayloadType::RequestHeaders,
            TurkiumdMessagePayloadType::RequestBlockLocator,
            TurkiumdMessagePayloadType::PruningPoints,
            TurkiumdMessagePayloadType::RequestPruningPointProof,
            ...
            TurkiumdMessagePayloadType::RequestIbdChainBlockLocator,
            TurkiumdMessagePayloadType::IbdChainBlockLocator,
            TurkiumdMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::TurkiumdMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "Turkium-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        ...
        let mut handshake = TurkiumdHandshake::new(&router);
